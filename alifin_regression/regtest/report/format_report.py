...
tb << tr(tdd('Table Name') + tdd('Base Row Count') + tdd('Curr Row Count') + tdd('Unmatched') + tdd('Comments') + tdd('Verify Result'), style="background-color:gray;color:white")
...
tb = page << table(align="center", style="width:100%")
tb << tr(td('Parallel working group: mingchao.xiamc', style="font:8pt Arial"))
