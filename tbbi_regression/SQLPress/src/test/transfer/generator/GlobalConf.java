...
class GlobalConf{
	...
	public static int sqlTokList[]={HiveParser.TOK_ALTERTABLE_ADDCOLS,
		HiveParser.TOK_ALTERTABLE_RENAMECOL
		};
	...
	private static int maxcasesnum=1;
	public static boolean iscn=true;
	public static String defaultProjectName="mztest";
	public static String defaultPartName="pt";
	...
	public static int getSize(ArrayList<CaseUnit> cunits) {
		int actualSize=cunits.size();
		return maxcasesnum<actualSize?GlobalConf.maxcasesnum:actualSize;
	}
}
