...
public class ODPSExecutorTest {
	...
	public static void main(String[] args) throws Exception, ClientException{
		...
		System.out.print("wori"+executor.execSQL("mztest", "desc t1;"));
		System.out.print("wocao"+ODPSExecutorTest.exec("mztest", "desc t1;"));
		ODPSExecutorTest.getFieldFromTable("mztest", "t1");
	}
