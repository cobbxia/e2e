...
public enum HiveOperation {
  ...
  EXPLAIN("EXPLAIN", null, null), // TODO: we need proper authorization here
  ...
  DESCTABLE("DESCTABLE", new Privilege[]{Privilege.DESCRIBE}, null), // TODO: we need proper authorization here
  ...
  ALTERTABLE_RENAMEPART("ALTERTABLE_RENAMEPART", new Privilege[]{Privilege.ALTER_METADATA}, null),
  ALTERTABLE_RENAME("ALTERTABLE_RENAME", new Privilege[]{Privilege.ALTER_METADATA}, null),
  ALTERTABLE_DROPPARTS("ALTERTABLE_DROPPARTS", new Privilege[]{Privilege.ALTER_METADATA}, null),
  ALTERTABLE_ADDPARTS("ALTERTABLE_ADDPARTS", new Privilege[]{Privilege.ALTER_METADATA}, null),
  ALTERTABLE_TOUCH("ALTERTABLE_TOUCH", new Privilege[]{Privilege.ALTER_METADATA}, null),
  ...
  ALTERTABLE_LIFECYCLE("ALTERTABLE_LIFECYCLE", new Privilege[]{Privilege.ALTER_METADATA, Privilege.DROP}, null),
  ALTERPARTITION_LIFECYCLE("ALTERPARTITION_LIFECYCLE", new Privilege[]{Privilege.ALTER_METADATA, Privilege.DROP}, null),
  ...
  ALTERTABLE_PARTITIONPROPERTIES("ALTERTABLE_PARTITIONPROPERTIES", new Privilege[]{Privilege.ALTER_METADATA}, null),
  ALTERPARTITION_SERDEPROPERTIES("ALTERPARTITION_SERDEPROPERTIES", new Privilege[]{Privilege.ALTER_METADATA}, null),
  ALTERPARTITION_PARTITIONPROPERTIES("ALTERPARTITION_PARTITIONPROPERTIES", new Privilege[]{Privilege.ALTER_METADATA}, null),
  ...
  SHOWTABLES("SHOWTABLES", null, new Privilege[]{Privilege.SHOW_TABLES}),
  SHOW_TABLESTATUS("SHOW_TABLESTATUS", null, null),
  SHOWFUNCTIONS("SHOWFUNCTIONS", null, null),
  SHOWINDEXES("SHOWINDEXES", null, null),
  SHOWPARTITIONS("SHOWPARTITIONS", new Privilege[]{Privilege.DESCRIBE}, null),
  ...
  CREATETABLE_LIKE("CREATETABLE_LIKE", new Privilege[]{Privilege.DESCRIBE}, new Privilege[]{Privilege.CREATE}),
  QUERY("QUERY", new Privilege[]{Privilege.SELECT}, new Privilege[]{Privilege.ALTER_DATA, Privilege.ALTER_METADATA}),
  ...
  STATISTIC_ADDDEF("ADD_STATISTIC_DEF", new Privilege[]{Privilege.ALTER_METADATA}, null),
  STATISTIC_REMOVEDEF("REMOVE_STATISTIC_DEF", new Privilege[]{Privilege.ALTER_METADATA}, null),
  STATISTIC_SHOWDEF("SHOW_STATISTIC_DEF", new Privilege[]{Privilege.DESCRIBE}, null),
  STATISTIC_SHOWVALUE("SHOW_STATISTIC_VALUE", new Privilege[]{Privilege.DESCRIBE}, null),
  STATISTIC_ANALYZE("STATISTIC_ANALYZE", new Privilege[]{Privilege.ALTER_METADATA, Privilege.SELECT}, null),
  COUNT("COUNT",new Privilege[]{Privilege.SELECT},null),
  READ("READ",new Privilege[]{Privilege.SELECT},null),
  SQLPLAN("SQLPLAN",new Privilege[]{Privilege.DESCRIBE},null),
  ;
